...
export class codeBlocksDataActions {
    ...
    static getCodeBlocks(lesson: Lesson): Action<Lesson> {
        return {
            type: codeBlocksDataActions.GET_CODE_BLOCKS,
            payload: lesson
        }
    }
    ...
    static getCodeBlocksSuccess(codeBlocks: CodeBlock[]): Action<CodeBlock[]> {
        return {
            type: codeBlocksDataActions.GET_CODE_BLOCKS_OK,
            payload: codeBlocks
        }
    }
    ...
    static getCodeBlocksFail(response: string): Action<string> {
        return {
            type: codeBlocksDataActions.GET_CODE_BLOCKS_ERR,
            payload: response
        }
    }
